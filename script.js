...
function setGraph(tab) {
    ...
    <text x="0" y="40" font-family="Verdana" font-size="12" fill="black">${totalXp}</text>
    <text x="0" y="90" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 10}</text>
    <text x="0" y="140" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 9}</text>
    <text x="0" y="190" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 8}</text>
    <text x="0" y="240" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 7}</text>
    <text x="0" y="290" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 6}</text>
    <text x="0" y="340" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 5}</text>
    <text x="0" y="390" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 4}</text>
    <text x="0" y="440" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 3}</text>
    <text x="0" y="490" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 2}</text>
    <text x="0" y="540" font-family="Verdana" font-size="12" fill="black">${step.toFixed(0) * 1}</text>
    <text x="0" y="590" font-family="Verdana" font-size="12" fill="black">0</text>
</svg>`
}
